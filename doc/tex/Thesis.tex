...
\input{chapters/_capa}
\newpage
\cleardoublepage

\input{chapters/_copyright}
% paragraf indentation
\setlength{\parindent}{1.5pt}
\setlength{\parskip}{1.5ex plus 0.5ex minus 0.2ex}
\onehalfspacing

\input{chapters/_acknowledgements}
\setlength{\parindent}{1.5pt}
...
\input{chapters/03_lyntaxproposal}
\input{chapters/04_lyntaxdevelopment}
\input{chapters/05_casestudies}
