...
As discussed in \cite{barisic_2012}, usability should be embedded in the \textsc{DSL} development process itself, and considered from the beginning of its developmen.
...
CONSTRUCTOR analyses the issued inpu, translates it into a semantic representation and, baed on that semantic representation, builds a visual construction.
